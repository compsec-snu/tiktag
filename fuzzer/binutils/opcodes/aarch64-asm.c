...
// reference: https://github.com/glaubitz/binutils-gdb/blob/f68d3e00531b5eef1941a097c4882395eb2f64e5/opcodes/aarch64-asm.c#L1962
...
int
_aarch64_opcode_encode (const aarch64_opcode *opcode,
		       ...
		       aarch64_operand_error *mismatch_detail)
{
  ...
  for (i = 0; i < AARCH64_MAX_OPND_NUM; ++i, ++info)
	...
	aarch64_insert_operand (opnd, info, &inst->value, inst, NULL);
    }
